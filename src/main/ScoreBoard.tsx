...
import { spellArray, participants, runeTree } from "./Utils";
import { getRuneInfo } from "../api/Champion";
      ...
      <div className="">
        <table className="rounded-t w-[740px]">
          ...
          <tbody className="bg-[#ECF2FF] border-t border-[#d5e3ff]">
            {gameData?.participants?.map(
              (partObj: participants, index: number) => {
                //           const participantData = partObj.filter(
                  ...
                  <tr className="table-row border-inherit align-middle">
                    ...
                    <td className="ward text-center text-[11px] text-gray-500">
                      <div className="relative block">
                        ...
                        <div className="block">
                          {gameData.wardsPlaced} / {gameData.wardsKilled}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="items text-center pt-1 pb-[3px] align-middle">
                      <div className="item ml-0 inline-block w-[22px] h-[22px] align-middle mx-[1px]">
                        <div className="relative">
                          {partObj.item0 ? (
                            <img
